...
const PastPage = () => (
	<PastContainer>
		<HeaderContainer>
			<h1>Here are some of our past performances...</h1>
		</HeaderContainer>
		<BodyContainer>
			<ItemBlock>
				<ItemContainer>
					<img
						src={"https://i.imgur.com/kuo1cqE.jpg"}
						alt="Pop Goes The Choir! Poster"
					/>
					<h3>Pop Goes The Choir!</h3>
			...
			<ItemBlock>
				<ItemContainer>
					<img
						src={"https://i.imgur.com/tT0Ztod.jpg"}
						alt="Songs of the Season Poster"
					/>
					<h3>Songs of the Season</h3> <span>December 15, 2019</span>
					<br />
					<span>Paul Shaghoian Concert Hall</span>
				</ItemContainer>
			</ItemBlock>
			...
			<ItemBlock>
				<ItemContainer>
					...
					<br />
					<span>Clovis Veterans Memorial Auditorium</span>
				</ItemContainer>
			</ItemBlock>
			<ItemBlock>
				<ItemContainer>
			...
			<ItemBlock>
				<ItemContainer>
					...
					<br />
					<span>Mercedes Edwards Theater</span>
				</ItemContainer>
			</ItemBlock>
			<ItemBlock>
				<ItemContainer>
